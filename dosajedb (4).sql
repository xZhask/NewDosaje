...
--
-- Servidor: localhost
-- Tiempo de generación: 18-02-2023 a las 17:34:21
...
CREATE TABLE `certificado` (
  ...
  `n_serie` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `certificado` (`id_infraccion`, `n_certificado`, `n_serie`, `estado`) VALUES
(10, 1520, '001', 'I'),
(8, 1521, '001', 'I'),
(10, 1522, '001', 'A'),
(8, 15926, '001', 'A'),
...
CREATE TABLE `comandancia` (
  ...
  `comisaria` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `extraccion` (
  ...
  `tipo_muestra` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `hora_extracc` time DEFAULT NULL,
  `fecha_extracc` date DEFAULT NULL,
  `hrs_transcurridas` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(4, 'S', '17:46:00', '2023-02-12', '02:1', 16, 10, 'APARENTE ESTADO '),
(5, 'N', '09:10:00', '2023-02-13', '02:0', 15, 11, 'SIN OBSERVACIONES');
...
CREATE TABLE `infraccion` (
  ...
  `hoja_registro` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Motivo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `fecha_infr` date NOT NULL,
  `hora_infr` time NOT NULL,
  `vehiculo` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `clase` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `placa` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `lugar_incidencia` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `n_certificado` int DEFAULT NULL,
...
INSERT INTO `infraccion` (`id_infraccion`, `hoja_registro`, `Motivo`, `fecha_infr`, `hora_infr`, `vehiculo`, `clase`, `placa`, `n_oficio`, `id_comandancia`, `hora_recepcion`, `fecha_recepcion`, `infractor`, `digitador`, `personal_conductor`, `lugar_incidencia`, `n_certificado`, `fecha_registro`) VALUES
(1, '2222', 'DESPISTE', '2023-02-09', '10:24:00', '', '', '', 489, 2, '00:45:20', '2023-02-08', 3, 1, 4, '', NULL, '0000-00-00 00:00:00'),
(2, '2222', 'DESPISTE', '2023-02-09', '10:24:00', '', '', '', 489, 2, '11:23:00', '2023-02-09', 3, 1, 4, '', NULL, '0000-00-00 00:00:00'),
(3, '', 'DESPISTE', '2023-02-09', '12:32:00', '-', '-', '-', 456, 1, '13:31:00', '2023-02-09', 3, 1, 4, '', NULL, '0000-00-00 00:00:00'),
(4, '', 'DESPISTE', '2023-02-09', '12:32:00', '-', '-', '-', 456, 1, '13:31:00', '2023-02-09', 3, 1, 4, '', NULL, '0000-00-00 00:00:00'),
(5, '2215', 'DESPISTE', '2023-02-09', '13:24:00', '-', '-', '-', 159, 2, '13:55:00', '2023-02-09', 3, 1, 4, '', NULL, '0000-00-00 00:00:00'),
(6, '2215', 'DESPISTE', '2023-02-09', '13:24:00', '-', '-', '-', 159, 2, '13:55:00', '2023-02-09', 3, 1, 4, '', NULL, '0000-00-00 00:00:00'),
(7, '2215', 'DESPISTE', '2023-02-09', '13:24:00', '-', '-', '-', 159, 2, '13:55:00', '2023-02-09', 3, 1, 4, '', NULL, '0000-00-00 00:00:00'),
(8, '456', 'DESPISTE', '2023-02-09', '14:28:00', '-', '-', '-', 456, 3, '15:28:00', '2023-02-09', 3, 1, 4, '', NULL, '0000-00-00 00:00:00'),
(9, '2325', 'DESPISTE', '2023-02-12', '15:45:00', '-', 'AIIB', 'TM13456', 159, 3, '17:43:00', '2023-02-12', 18, 1, 4, '', NULL, '0000-00-00 00:00:00'),
(10, '2325', 'DESPISTE', '2023-02-12', '15:45:00', '-', 'AIIB', 'TM13456', 159, 3, '17:43:00', '2023-02-12', 18, 1, 4, '', NULL, '0000-00-00 00:00:00'),
(11, '2024', 'DESPISTE', '2023-02-13', '07:10:00', '-', '-', '-', 456, 6, '09:09:00', '2023-02-13', 3, 1, 4, '', NULL, '0000-00-00 00:00:00');
...
CREATE TABLE `peritaje` (
  ...
  `result_cualitativo` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `result_cuantitativo` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `persona` (
  ...
  `nro_doc` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `nacionalidad` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(17, 7, '09555665', 'HERENCIA TORRES, MARILUZ', NULL, NULL, NULL, 'CRNL SPNP', 'Peruana'),
(18, 7, '16456828', 'SILVA SANCHEZ, CESAR AUGUSTO', 25, '-', 'M', NULL, 'Peruana');
...
CREATE TABLE `usuario` (
  ...
  `profesion` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(17, '$2y$07$pAiRY3QtTnm0uJk8dME5COXr6tNiRgTqpSzlXDBrM8K4vJI18KAly', 'P', 2, 'A');
...
--
ALTER TABLE `extraccion`
  MODIFY `id_extraccion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `infraccion`
--
ALTER TABLE `infraccion`
  MODIFY `id_infraccion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `peritaje`
  MODIFY `id_peritaje` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `certificado`
  ADD CONSTRAINT `certificado_ibfk_1` FOREIGN KEY (`id_infraccion`) REFERENCES `infraccion` (`id_infraccion`);
