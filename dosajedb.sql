...
--
-- Servidor: localhost
-- Tiempo de generación: 13-02-2023 a las 04:26:32
...
CREATE TABLE `certificado` (
  ...
  `n_serie` varchar(3) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(9, '2325', 'DESPISTE', '2023-02-12', '15:45:00', '-', 'AIIB', 'TM13456', 159, 3, '17:43:00', '2023-02-12', 18, 1, 4, '', NULL),
(10, '2325', 'DESPISTE', '2023-02-12', '15:45:00', '-', 'AIIB', 'TM13456', 159, 3, '17:43:00', '2023-02-12', 18, 1, 4, '', NULL);
...
--
ALTER TABLE `extraccion`
  MODIFY `id_extraccion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `infraccion`
--
ALTER TABLE `infraccion`
  MODIFY `id_infraccion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `peritaje`
  MODIFY `id_peritaje` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
